...
namespace ApiCognosV1.Controllers
{
    ...
    public class ellisController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("MaestroHistEllisList/{Id}")]
        public IEnumerable<Maestro_pruebas_hist> MaestroHistEllisList(int Id)
        {
            return _context.Maestro_pruebas_hist.Where(e => e.maestro_id_paciente == Id && e.maestro_tipo_prueba == 6).OrderByDescending(e => e.maestro_fecha).ToList();
        }
        ...
        [HttpPost]
        [Route("GuardarImagenEllisHist")]
        public IActionResult GuardarImagenEllisHist(IFormFile files, int id_pac, int tipo_prueba, int maestro_id)
        {
            var respuesta = new Respuesta();
        ...
        [HttpPost]
        [Route("MaestroHistCREE")]
        public IActionResult InsertMaestroHistCREE(int maestro_id_paciente, string fecha,string observ)
        {
